...
export class HomeComponent implements OnInit {
  ...
  public slides = [
    { title: 'The biggest sale', subtitle: 'Special for today', image: 'assets/images/products/headset/1-medium.png' },
    { title: 'collection', subtitle: 'New Arrivals On Sale', image: 'assets/images/products/pc/1-medium.png' },
    { title: 'The biggest sale', subtitle: 'Special for today', image: 'assets/images/products/probook/1-medium.png' },
    { title: 'collection', subtitle: 'New Arrivals On Sale', image: 'assets/images/products/printer/1-medium.png' },
